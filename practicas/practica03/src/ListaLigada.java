public class ListaLigada {
    ...
    /**
     * Metodo para convertir la lista en una cadena que contiene a sus elementos.
     * 
     * @return resp la cadena de elementos
     * 
     */
    public String toString () {
        String resp = "";
        Nodo  nodoActual = this.cabeza;
        // Agrega el elemento actual mientras el nodo actual no sea nulo.
        while (nodoActual != null){
            resp += (nodoActual.getElemento() + " ");
            nodoActual = nodoActual.getSiguiente();
        }
        return resp;
    }
     ...
     * 
     */
    public void insertarIndice (int i, int n){
